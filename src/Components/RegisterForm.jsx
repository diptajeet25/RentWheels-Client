...
const RegisterForm = () => {
  ...
  return (
    <div className="w-[95%] lg:w-[40%] mx-auto my-12 p-8 bg-white border rounded-2xl shadow-xl">
        ...
        <div>
          ...
          <input
            ...
            {...register("password", {
              ...
              pattern: {
                value: /^(?=.*[a-z])(?=.*[A-Z]).{6,}$/,
                message: "Must include uppercase, lowercase & 6 characters"
              }
            })}
          />
      ...
      <button onClick={googleLogIn} className="btn bg-gray-100 text-black w-full my-4 border border-gray-200">
        Login with Google
      </button>
